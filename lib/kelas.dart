...
class PageKelas extends StatefulWidget {
  @override
  _PageKelasState createState() => _PageKelasState();
}
...
class _PageKelasState extends State<PageKelas> {
  ...
  Future<void> _fetchData() async {
    final response = await http
        .get(Uri.parse('http://localhost/pesantren_api/api/get-kelas'));
          ...
          if (isDesktop)
            Positioned(
              ...
              child: Container(
                ...
                child: MarqueeText(
                  text:
                      'Selamat Datang di Halaman Data Kelas - Silentdra Assesstment',
                  style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: Colors.black,
  ...
  List<DataRow> _buildDataRows() {
    final filteredData = _data.where((row) {
      ...
      return kelas.contains(searchQuery) || sekolah.contains(searchQuery);
    }).toList();
            ...
            child: ListView(
              ...
              children: [
                ...
                _buildSidebarItem(Icons.calendar_today, 'Tahun Akademik', false,
                    PageTahunAjaran()),
                _buildSidebarItem(Icons.class_, 'Kelas', true, PageKelas()),
