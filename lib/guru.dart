...
class _PageGuruState extends State<PageGuru> {
  ...
  Future<void> _fetchData() async {
    final response = await http
        .get(Uri.parse('http://localhost/pesantren_api/api/get-guru'));
          ...
          if (isDesktop)
            Positioned(
              ...
              child: Container(
                ...
                child: MarqueeText(
                  text:
                      'Selamat Datang di Halaman Data Guru - Silentdra Assesstment',
                  style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: Colors.black,
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _buildSidebarItem(Icons.person, 'Guru', true, PageGuru()),
                _buildSidebarItem(
                ...
                _buildSidebarItem(Icons.app_registration, 'Data Pendaftaran', true,
                    DataPendaftaran()),
              ],
            ),
          ),
