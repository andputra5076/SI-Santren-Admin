...
class _DataPendaftaranState extends State<DataPendaftaran> {
  ...
  Future<void> _fetchData() async {
    final response = await http
        .get(Uri.parse('http://localhost/pesantren_api/api/get-pendaftaran'));
          ...
          if (isDesktop)
            Positioned(
              ...
              child: Container(
                ...
                child: MarqueeText(
                  text:
                      'Selamat Datang di Halaman Data Pendaftaran Sekolah - Silentdra Assesstment',
                  style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: Colors.black,
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: SingleChildScrollView(
                  ...
                  child: MarqueeText(
                    text:
                        'Selamat Datang di Halaman Data Penfataran - Silentdra Assesstment',
                    style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                      color: Colors.black,
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                labelText: 'Cari Pendaftaran Sekolah',
  ...
  void _showEditModal(Map<String, dynamic> school) {
    showDialog(
      ...
      builder: (context) {
        ...
        String telp = school['telp'].toString();
        String email = school['email'].toString();
  ...
  List<DataRow> _buildDataRows() {
    ...
    return visibleData.asMap().entries.map<DataRow>((entry) {
      ...
      return DataRow(cells: [
        ...
        DataCell(Text(row['telp'].toString() ?? '')),
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _buildSidebarItem(Icons.app_registration, 'Data Pendaftaran',
                    true, DataPendaftaran()),
              ],
            ),
          ),
          Container(
