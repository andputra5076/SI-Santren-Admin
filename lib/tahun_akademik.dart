...
class PageTahunAjaran extends StatefulWidget {
  @override
  _PageTahunAjaranState createState() => _PageTahunAjaranState();
}

class _PageTahunAjaranState extends State<PageTahunAjaran> {
  ...
  Future<void> _fetchData() async {
    final response = await http
        .get(Uri.parse('http://localhost/pesantren_api/api/get-tahun'));
          ...
          if (isDesktop)
            Positioned(
              ...
              child: Container(
                ...
                child: MarqueeText(
                  text:
                      'Selamat Datang di Halaman Data Tahun Akademik - Silentdra Assesstment',
                  style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: Colors.black,
  ...
  List<DataRow> _buildDataRows() {
    final filteredData = _data.where((row) {
      final tahun = row['tahun'].toString().toLowerCase();
      final sekolah = row['sekolah'].toString().toLowerCase();
      final searchQuery = _searchQuery.toLowerCase();
      return tahun.contains(searchQuery) || sekolah.contains(searchQuery);
    }).toList();
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _buildSidebarItem(Icons.calendar_today, 'Tahun Akademik', true,
                    PageTahunAjaran()),
